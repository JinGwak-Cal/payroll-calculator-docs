<!-- Auto-generated at 2026-06-25T22:51:47Z -->
...
* 기존 컴포넌트 재사용 전 확인 규칙
  · 기존 컴포넌트/훁/유트 재사용 가능 여부를 먼저 조사
  · import 확인 → 중첨 확인 → 구현 순서 준수
...
* Replit 프롬프트 작성 체크리스트
  ...
  · 현재 STEP 범위 확인 / 기존 컴포넌트/훁/유트 재사용 여부 조사
  · import 중복·중첨 확인 / 복붙 가능한 최종본 제시 / 첫 줄 판정 명시
...
* 2줄 표준 형식 (공통 UI 규격)
  ...
  · 목록 / 선택 Sheet / 비에편집 / 요약 카드 모두 동일 형식 적용
  · 예시
...
* 비교편집 UX 방향 확정
  · MVP를 먼저 구현하여 현재 STEP 범위를 유지하고, 3단 비에편집은 후속 STEP으로 분리한다.
