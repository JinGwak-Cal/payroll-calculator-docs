# Operation Review SOP v0.2

Status: Draft v0.2 (OR-METHOD-001 산출물, Freeze 아님. v0.1은
notes/OR-SOP-v0.1.md에 보존)
...
├── P4 Traceability Walkthrough (CL-010/CR-003: 정식 Operation
│     Review(OR-0001 이상)에서는 Second-pass Reviewer의 **실제
│     독립 재현이 필수**. 같은 작성자가 관점만 분리하는 "간이형"은
│     Pilot(OR-0000류)에서만 허용되는 예외이며, 결과에 반드시
│     "간이형" 표시를 남긴다. 근거: OR-0000 WD-0001에서 간이형
│     수행, 완전한 제3자 재현 아니었음을 자인)
└── P5 Exit Decision
```
